...
//http://pure-data.svn.sourceforge.net/viewvc/pure-data/trunk/externals/vanilla/keyup.c?revision=12749&view=markup
//http://pure-data.svn.sourceforge.net/viewvc/pure-data/trunk/externals/vanilla/key.c?revision=12749&view=markup
...
static void keyboard_setvalues(t_keyboard *x, t_floatarg width, t_floatarg height, 
    ...
    x->height = (height>3)?height:80;
    x->octaves = (octaves > 1)?octaves:2;
    x->first_c = (first_c > -1)?first_c:60;
...
void * keyboard_new(t_floatarg width, t_floatarg height, t_floatarg octaves, t_floatarg first_c) {
    t_keyboard *x = (t_keyboard *) pd_new(keyboard_class);
    keyboard_setvalues(x, width, height, octaves, first_c, 1);
